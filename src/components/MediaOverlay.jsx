                ...
                {contextTokens.cached != null && (contextTokens.fresh + contextTokens.cached) > 0 && (
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '3px' }}>
                    ...
                    <span style={{ fontSize: '15px', fontVariantNumeric: 'tabular-nums' }}>
                      <span style={{ color: '#f59e0b' }} title="taze (cache-miss) input — pahalı">taze {fmtK(contextTokens.fresh)}</span>
                      <span style={{ color: '#395873' }}> · </span>
                      <span style={{ color: '#4ade80' }} title="cache okuma — sıcak oturum, ucuz">cache {fmtK(contextTokens.cached)}</span>
                    </span>
                  </div>
                )}
              </div>
