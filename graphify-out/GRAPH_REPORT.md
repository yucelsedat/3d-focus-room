...
## Corpus Check
- 33 files · ~90,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 336 nodes · 475 edges · 22 communities detected
...
Cohesion: 0.1
Nodes (11): CanvasMesh(), disposePoolAudio(), formatBytes(), getBounds(), getPoolAudio(), imageName(), ImageViewer(), InstaCard() (+3 more)
...
Cohesion: 0.17
Nodes (7): ensureSessionOr429(), fetchHtmlHead(), LoopRunner, makeTurnSink(), pidRssMb(), SessionPool, stopRoomBackgroundWork()
...
Cohesion: 0.19
Nodes (9): addUsage(), MultiAgentRunner, readAgentProfile(), readRecall(), recallDir(), recallPath(), setSSEHeaders(), streamClaudeToSSE() (+1 more)
...
- **Thin community `Community 9`** (8 nodes): `WorldSelect.jsx`, `CardMenu()`, `ContextCard()`, `ContextModal()`, `DeleteConfirmModal()`, `hashIndex()`, `MenuItem()`, `WorldSelect()`
...
- **Why does `PersistentSession` connect `Community 4` to `Community 0`, `Community 8`, `Community 2`?**
